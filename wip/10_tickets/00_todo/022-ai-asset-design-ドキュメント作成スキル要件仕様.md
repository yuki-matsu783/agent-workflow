...
- [ ] `.claude/docs/00_requirements/要件定義書作成.md`（type: requirements）が作成されている
- [ ] `.claude/docs/10_spec/要件定義書作成.md`（type: spec）が作成されている
- [ ] `.claude/docs/00_requirements/仕様書作成.md`（type: requirements）が作成されている
- [ ] `.claude/docs/10_spec/仕様書作成.md`（type: spec）が作成されている
...
- [ ] specは対応するSKILL.mdの手順・テンプレート項目・入出力を反映している
