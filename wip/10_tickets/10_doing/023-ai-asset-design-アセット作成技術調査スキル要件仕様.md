...
- [ ] `.claude/docs/00_requirements/AIアセット作成.md`（type: requirements）が作成されている
- [ ] `.claude/docs/10_spec/AIアセット作成.md`（type: spec）が作成されている
- [ ] `.claude/docs/00_requirements/技術調査.md`（type: requirements）が作成されている
- [ ] `.claude/docs/10_spec/技術調査.md`（type: spec）が作成されている
